...
<div class="row mb-3">
 ...
 <tbody>
	 ...
	 <td><?= $row['harga'];?></td>
 <td>
        <a href="<?= base_url; ?>/buku/edit/<?= $row['id'] ?>" class="badge badgeinfo">Edit</a> 
        <a href="<?= base_url; ?>/buku/hapus/<?= $row['id'] ?>" class="badge badgedanger" onclick="return confirm('Hapus data?');">Hapus</a>
 </td>
 </tr>
 <?php $no++; endforeach; ?>
</tbody>
